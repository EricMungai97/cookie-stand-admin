...
export default function Form() {
  ...
  return (
    <div className=''>
      ...
      <form onSubmit={inputHandler} className="bg-violet-300 rounded border-2 text-white border-violet-400 justify-center mt-10 p-5 mr-20 ml-20 flex flex-col ">
        <fieldset>
          ...
          <button className="bg-violet-500 text-white font-bold  py-2 px-4 rounded hover:bg-violet-800 w-20  mt-4 mr-5 ml-5 flex-wrap ">Create</button>
        </fieldset>
